...
The main fill-style TOC. Two animation variants available:

- **JavaScript** - Uses `requestAnimationFrame` for synchronized animations
- **CSS** - Uses CSS transitions for a lighter approach

To switch variants, change the import in [toc-fill-server.tsx](app/docs/components/docs/toc-fill-server.tsx):
...
With server wrapper (used in [page.tsx](app/docs/[[...slug]]/page.tsx)):
